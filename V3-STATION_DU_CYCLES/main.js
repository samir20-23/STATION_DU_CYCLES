// Import components
import { createDeliveryBanner } from "../V2-STATION_DU_CYCLES/components/delivery-banner.js"
import { createMegaBanner } from "../V2-STATION_DU_CYCLES/components/mega-banner.js"
import { createNavbar } from "../V2-STATION_DU_CYCLES/components/navbar.js"
import { createHeroSection } from "../V2-STATION_DU_CYCLES/components/hero-section.js"
import { createStoreInfo } from "../V2-STATION_DU_CYCLES/components/store-info.js"
import { createStoreHours } from "../V2-STATION_DU_CYCLES/components/store-hours.js"
import { createFooter } from "../V2-STATION_DU_CYCLES/components/footer.js"
...
const I18N = {
  ar: {
    ...
    hours: {
      ...
      openNow:'مفتوح اليوم', closedToday:'مغلق اليوم',
      notesTitle:'ملاحظات خاصة', note1:'• مغلق يوم الإثنين', note2:'• عروض خاصة في نهاية الأسبوع', note3:'• يُفضّل الاتصال قبل الزيارة',
      days:['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday']
    },
    product: { specs:'المواصفات التقنية', ratingOf:'من 5', buy:'اشترِ الآن', whatsapp:'تواصل واتساب',
      breadcrumbHome:'الرئيسية'
    },
    cta: { title:'هل تريد دراجة مناسبة لك؟', subtitle:'اترك معلوماتك وسنتواصل معك فوراً لتقديم أفضل العروض وخيارات التمويل.' },
    form: {
      ...
      send:'أرسل طلبي الآن', whatsapp:'تواصل واتساب مباشر', success:'✅ تم إرسال طلبك بنجاح! سنتواصل معك قريباً جداً.'
    },
    footer:{
      about:'متخصصون في بيع الدراجات النارية والسكوترات مع ضمان وخدمات ما بعد البيع. اختَر راحتك وسنُنجز الباقي.',
      linksTitle:'روابط', offers:'عروض وتمويل', contact:'اتصل بنا',
      hoursTitle:'المواعيد', hoursRange:'الإثنين – السبت: 9:00–19:00', sunday:'الأحد: مغلق',
      newsletterTitle:'اشترك ليصلك كل جديد', emailPlaceholder:'بريدك الإلكتروني', subscribeBtn:'اشترك الآن', subscribed:'تم الاشتراك بنجاح ✅'
    },
    copyright: '© 2025 مصطفى للدراجات النارية. جميع الحقوق محفوظة.'
  },
  fr: {
    dir: 'ltr', lang: 'fr',
    banner: { delivery: '🚀 Bienvenue dans le monde de la vitesse et des sensations — découvrez nos meilleures motos dès aujourd'hui ! 🏍️🔥' },
    ...
    storeInfo: { title:'Informations du magasin', phone:'Téléphone', address:'Adresse', mapTitle:"Emplacement sur la carte" },
    hours: {
      title:'Horaires du magasin', opening:"Heures d'ouverture", today:"Statut d'aujourd'hui",
      openNow:'Ouvert aujourd'hui', closedToday:'Fermé aujourd'hui',
      notesTitle:'Notes', note1:'• Fermé le lundi', note2:'• Offres spéciales le week-end', note3:'• Merci d'appeler avant de venir',
      days:['Dimanche','Lundi','Mardi','Mercredi','Jeudi','Vendredi','Samedi']
    },
    product: { specs:'Caractéristiques techniques', ratingOf:'sur 5', buy:'Acheter maintenant', whatsapp:'WhatsApp',
      breadcrumbHome:'Accueil'
    },\
    cta: { title:\'Vous voulez la moto idéale ?', subtitle:'Laissez vos informations et nous vous contacterons avec les meilleures offres et options de financement.' },
    form: {
      ...
      send:'Envoyer la demande', whatsapp:'WhatsApp direct', success:'✅ Votre demande a été envoyée ! Nous vous contacterons très bientôt.'
    },
    footer:{
      about:\'Spécialistes des motos et scooters avec garantie et service après-vente. Choisissez le confort, on s\'occupe du reste.\',
      linksTitle:'Liens', offers:'Offres & Financement', contact:'Contactez-nous',
      hoursTitle:'Horaires', hoursRange:'Lun – Sam : 9:00–19:00', sunday:'Dimanche : Fermé',
      newsletterTitle:'Abonnez-vous', emailPlaceholder:'Votre e-mail', subscribeBtn:'S'abonner', subscribed:'Abonnement réussi ✅'
    },
...
\
// يطبّق الترجمة على العناصر ذات data-i18n و placeholders
...
function openPurchaseModal(id) {
  currentProductId = id
  alert(getLang()==='ar' ? 'طلب الشراء: سيتم التواصل معك قريباً.' : 'Demande d'achat : nous vous contacterons bientôt.');
}
